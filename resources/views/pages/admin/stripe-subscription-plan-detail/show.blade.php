...
@section('content')
    <x-laravel-components-card>
        ...
        <x-laravel-components-card-data
            :data="[['label' => 'Name', 'value' => $stripeSubscriptionPlanDetail->name], ['label' => 'Stripe Product ID', 'value' => $stripeSubscriptionPlanDetail->stripe_product_id], ['label' => 'Price', 'value' => $stripeSubscriptionPlanDetail->price], ['label' => 'Display Price', 'value' => $stripeSubscriptionPlanDetail->display_price], ['label' => 'Tier', 'value' => App\Subscription\SubscriptionTiers::toLabel($stripeSubscriptionPlanDetail->tier->value)], ['label' => 'Trials Length Days', 'value' => $stripeSubscriptionPlanDetail->trial_length_days], ['label' => 'Description', 'value' => $stripeSubscriptionPlanDetail->description]]"
        />
    </x-laravel-components-card>
@endsection
@push('modals')
